  ...
  return (
    <React.Fragment>
      <div className="header">
        ...
        <div className="Nav">
          <ul className="items">
            <li><span>Why Marvel</span></li>
            <li><span>Enterprise</span></li>
            <li><span>Pricing</span></li>
            <li><span>Sign in</span></li>
            <li><span className="signup">Sign up free</span></li>
          </ul>
        </div>
      </div>
      <div className="banner">
      <div className="banner_left_quote">
        <h1><span>Let's build the future</span></h1><br/>
        <h1>of design, now.</h1>
        <p className="small_description">Create amazing tools and intergration for 1 million users or customise Marvel for your team.</p>
