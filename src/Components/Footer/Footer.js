...
function Footer() {
    const footer_menu = {
        arr1:["Overview","Enterprise","Pricing","Request","Explore","Apps","Developer"],
        arr2:["Features","Wireframing","Prototyping","Collaboration","Handoff","Integrations","Sketch Plugin"],
        arr3:["Support","Hel Center","Terms of Service","Privacy","Security"],
        arr4:["Marvel","Blog","Our Team","Contact Us","Success Stories","Brand Guidelines"],
        arr5:["Twitter","Dribble","Facebook","Github","Workable"]
    }
  ...
  return (
    <React.Fragment>
      <div className="footer">
        ...
        <div className="footerMenu">
        <ul>
                {footer_menu.arr2.map((res)=>(
                    <li>{res}</li>
                ))}
            </ul>
        </div>
        <div className="footerMenu"><ul>
                {footer_menu.arr3.map((res)=>(
                    <li>{res}</li>
                ))}
            </ul></div>
        <div className="footerMenu"><ul>
                {footer_menu.arr4.map((res)=>(
                    <li>{res}</li>
                ))}
            </ul></div>
        <div className="footerMenu"><ul>
                {footer_menu.arr5.map((res)=>(
                    <li>{res}</li>
                ))}
            </ul></div>
      </div>
