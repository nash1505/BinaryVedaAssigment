    ...
    return (
        <React.Fragment>
                <div className="Center_quote">
                    ...
                    <small>You can now harness components of our platform and build powerful</small>
                    <small>integrations for our 2 million users-or simply just for your team.</small>
                </div>
                <div className="showCase">
                    <div className="showCaseItem">
                        <img src={itemone} alt="itemOne"></img>
                        <span className="subHeading">Dedicated API Team</span>
                        <small>Our team are available for user's questions </small>
                        <small>via our slack Developer Community and Email</small>
                    </div>
                    <div className="showCaseItem">
                    <img src={itemtwo} alt="itemTwo"></img><br/>
                    <span className="subHeading">Our API uses Graph QL</span>
                    <small>Not handling server side. Get many API's</small>
                    <small>responses in a single request.</small>
                    </div>
                    <div className="showCaseItem">
                        <img src={itemthree} alt="itemThree"></img>
                        <span className="subHeading">Supercharge Your Workflow</span>
                        <small>Automate workflows, integarte ad analyse data</small>
                        <small>and take Marvel to the next level.</small>
                    </div>
                </div>
                <div className="showCaseTwin">
                    <div className="showCaseTwin_left">
                        ...
                        <small>Building something special? We're always looking to work</small>
                        <small>with partners who wants to help the world bring their ideas </small>
                        <small>to life.</small>
